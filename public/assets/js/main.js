document.addEventListener('DOMContentLoaded', () => {
  ...
  const I18N = {
    en: {
      ...
      hero_role: 'Cloud & DevOps Consultant',
      hero_title: 'Cloud & DevOps Consultant',
      ...
      about_text: `
        <p>
          Hi! I'm Hamza, a Cloud & DevOps Consultant with a strong foundation in systems, networks, Azure
    ...
    fr: {
      ...
      nav_contact: 'Contact',
      hero_role: "Consultant Cloud & DevOps",
      hero_title: 'Consultant Cloud & DevOps',
  ...
  function applyLanguage(lang) {
    ...
    function applyBilingualBlocks(code) {
      ...
      const hrefAttr = normalized === 'en' ? 'data-href-en' : 'data-href-fr';
      ...
      document.querySelectorAll('[' + hrefAttr + ']').forEach(el => {
