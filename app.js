...
// - services/backend/.env (if present)
// - repo root .env (recommended for local dev)
// - or rely on runtime env vars (containers/Kubernetes)
const localEnvPath = path.join(__dirname, '.env');
const repoEnvPath = path.join(__dirname, '..', '..', '.env');
const envPath = process.env.DOTENV_PATH || (fs.existsSync(localEnvPath) ? localEnvPath : repoEnvPath);
...
const FRONTEND_PUBLIC_DIR = process.env.FRONTEND_PUBLIC_DIR
